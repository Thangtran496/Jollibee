...
<body>
			...
			<div
				...
				<div class="flex-fill">
					<ul
						...
						<li class="nav-item"><a class="nav-link" href="Jollibee">Trang
								chủ</a></li>
						<li class="nav-item"><a class="nav-link" href="Dichvu">Dịch
								vụ</a></li>
				...
				<div class="navbar align-self-center d-flex">
					...
					<a class="nav-icon d-none d-lg-inline" href="#"
						...
						href="Login"> <i class="fa fa-fw fa-user text-dark mr-3"></i>
						<span
						class="position-absolute top-0 left-100 translate-middle badge rounded-pill bg-light text-dark"></span>
					</a>
				</div>
	...
	<div class="d-flex flex-row-reverse">
		<button type="button" class="btn btn-warning m-3">Đặt hàng
			theo nhóm</button>
	</div>

	<div class="tab-content">
		<div id="combo"
			class="container d-flex justify-content-center tab-pane active">
			<div class="row w-75">
				<div class="col-xl-4">
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<p class="card-text">Some quick example text to build on the
								Combo and make up the bulk of the card's content.</p>
		...
		<div id="gagion"
			class="container d-flex justify-content-center tab-pane ">
			<div class="row w-75">
				<div class="col-xl-4">
					<div class="card">
						<img src="img/product.jpeg" class="card-img-top" alt="...">
						<div class="card-body">
							...
							<p class="card-text">Some quick example text to build on the
								Gagion and make up the bulk of the card's content.</p>
							<a href="#" class="btn btn-primary">Go somewhere</a>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-4">
					<div class="card">
						...
						<div class="card-body">
							...
							<p class="card-text">Some quick example text to build on the
								Gacay and make up the bulk of the card's content.</p>
							<a href="#" class="btn btn-primary">Go somewhere</a>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-4">
					<div class="card">
						...
						<div class="card-body">
							...
							<p class="card-text">Some quick example text to build on the
								Mi Y and make up the bulk of the card's content.</p>
							<a href="#" class="btn btn-primary">Go somewhere</a>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-4">
					<div class="card">
						...
						<div class="card-body">
							...
							<p class="card-text">Some quick example text to build on the
								Burger and make up the bulk of the card's content.</p>
							<a href="#" class="btn btn-primary">Go somewhere</a>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-4">
					<div class="card">
						...
						<div class="card-body">
							...
							<p class="card-text">Some quick example text to build on the
								AnPhu and make up the bulk of the card's content.</p>
							<a href="#" class="btn btn-primary">Go somewhere</a>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-4">
					<div class="card">
						...
						<div class="card-body">
							...
							<p class="card-text">Some quick example text to build on the
								TrangMieng and make up the bulk of the card's content.</p>
							<a href="#" class="btn btn-primary">Go somewhere</a>
						</div>
					</div>
				</div>
